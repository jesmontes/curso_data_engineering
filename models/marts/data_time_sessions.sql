...
data_time_sessions_cte AS (
   SELECT 
    ...
    TIMESTAMPDIFF('minute',init_session_time,time_checkout) as duration_session_init_to_checkout_min,
    TIMESTAMPDIFF('minute',time_checkout,time_package_shipped) as duration_preparing_to_shipped_min,
    TIMESTAMPDIFF('minute',init_session_time,finish_session_time) as duration_session_total_min,
