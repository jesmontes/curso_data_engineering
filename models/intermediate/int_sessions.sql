...
WITH stg_sessions AS (
    ...
    SELECT 
        ...
        TIMESTAMPDIFF('hour',checkout_event_time_utc,package_shipped_event_time_utc) AS preparing_to_shipped_length_time_hour,
        TIMESTAMPDIFF('day',checkout_event_time_utc,package_shipped_event_time_utc) AS preparing_to_shipped_length_time_day
    FROM stg_sessions a
    JOIN stg_users b
